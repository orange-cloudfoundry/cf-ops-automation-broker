...
# Example:
#
# release.sh github_api_token=TOKEN owner=orange-cloudfoundry repo=cf-ops-automation-broker tag=v0.1.0 filename=./cf-ops-automation-cloudflare-broker-0.0.1-SNAPSHOT.jar
#
