- harden handling of deprovision error
       Symptom: 
       ...
       Diagnostic:
         - root cause in C* broker https://github.com/orange-cloudfoundry/cassandra-cf-service-boshrelease/issues/33
         
         - check if CC indeed performs retries and eventually removes the service instance
           - logsearch to get log history
         - check specs for expected behavior
