...
- set COA rules as constants (in DeploymentConstants?) instead of configuration flags:
...
- remove prereq to have a file `operators/coab-operators.yml` present but still preserve symlinking it
